    ...
    <div class="col-md-3"></div>
            <div class="col-md-6">
                <div class="card my-5 shadow-sm">
                    <div class="card-header">{{ __('Server Details') }}</div>
                    ...
                    <div class="card-body">
                        <div class="row p-1">
                            ...
                            <div class="col-sm-4 text-left"><p>SSH Key:</p></div> <div class="col-sm-8 text-right text-wrap"><p><textarea class="form-control" style="overflow:auto;" id="exampleFormControlTextarea1" rows="3" readonly>{{ $server->public_key }}</textarea></p></div>
                        </div>
                    </div>
                </div>
            </div>
